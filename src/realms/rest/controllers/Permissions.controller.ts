...
import {CreateGroupBodySchema, CreateGroupSchema, GetGroupSchema} from "./schemas/Permissions.schema";
...
export default class PermissionsController {
  ...
  async createGroup(req: RequestWithKey<{ Body: CreateGroupBodySchema }>, reply: FastifyReply) {
